...
formula_json_paths = [
    os.path.join(os.path.dirname(__file__), '../output/runtime/final_formulas_gpt.json'),
...
output_json_path = os.path.join(os.path.dirname(__file__), '../output/runtime/final_nmae_gpt.json')
